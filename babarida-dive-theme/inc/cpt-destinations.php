...
function bdc_register_destination() {
    ...
    register_post_type('bdc_destination', $args);

    // Taxonomy: already registered in cpt-trips.php as shared taxonomy
}
...
function bdc_save_destination($post_id) {
    if (!isset($_POST['bdc_dest_nonce_field']) || !wp_verify_nonce($_POST['bdc_dest_nonce_field'], 'bdc_dest_nonce')) return;
